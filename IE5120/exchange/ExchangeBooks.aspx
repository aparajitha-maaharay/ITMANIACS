    ...
    <!--breadcrumbs end-->
        ...
        <div class="col-lg-9 ">
            ...
            <ItemTemplate>
                ...
                <h2><b style="font-weight:bold">Author:</b> <%#Eval("Author") %></h2><br />
                <h2><b style="font-weight:bold">Culture:</b> <%#Eval("Culture") %></h2><br />
                <h2><b style="font-weight:bold">Description:</b> <%#Eval("Description") %></h2><br />
